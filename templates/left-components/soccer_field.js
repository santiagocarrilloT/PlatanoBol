...
class soccerField extends HTMLElement {
  constructor() {
    super();
  ...
  connectedCallback() {
    this.lineupsText = this.getAttribute("lineupText") || "0-0-0";
  ...
  render() {
    ...
    <style>${soccerField.styles}</style>
    <div class="stadium">
        <div class="half">
          <div class="area">
        ...
        <div class="players">
            <div class="home lineup-1" style="--lineup: ${this.lineupsForm}">
              <soccer-field-player number="1"></soccer-field-player>
              <soccer-field-player number="2"></soccer-field-player>
              <soccer-field-player number="3"></soccer-field-player>
              <soccer-field-player number="4"></soccer-field-player>
              <soccer-field-player number="5"></soccer-field-player>
              <soccer-field-player number="6"></soccer-field-player>
              <soccer-field-player number="7"></soccer-field-player>
              <soccer-field-player number="8"></soccer-field-player>
              <soccer-field-player number="9"></soccer-field-player>
              <soccer-field-player number="10"></soccer-field-player>
              <soccer-field-player number="11"></soccer-field-player>
            </div>
        </div>
      </div>
    `;
...
customElements.define("soccer-field", soccerField);
