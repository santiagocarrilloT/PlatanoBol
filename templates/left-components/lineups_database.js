...
class SoccerFieldDb extends HTMLElement {
  constructor() {
    super();
  ...
  connectedCallback() {
    this.lineupsForm = this.getAttribute("lineupsForm") || "";
    this.render();
  }

  render() {
    this.shadowRoot.innerHTML = /*html*/ `
    <style>${SoccerFieldDb.styles}</style>
    <div class="stadium">
        <div class="half">
          <div class="area">
...
customElements.define("soccer-field-db", SoccerFieldDb);
